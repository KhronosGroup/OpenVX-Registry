...
<p>The OpenVX 1.2.1 specification was generated by via a different tool chain
  than previous versions, but the content of OpenVX 1.2.1 is identical to that
  of OpenVX 1.2.  The 1.2 headers, sample implementation, and conformance tests
  are still applicable to 1.2.1.</p>
<ul>

...
<ul>
    ...
    <ul>
        <li>
            Corrections to OpenVX Specification 1.3.1 (<a
                href="specs/1.3.1/OpenVX_Specification_1_3_1_Correction_1_changes.pdf">PDF</a>)
            (updated Nov 07, 2023).
        </li>
    </ul>
...
<ul>
    <li>OpenVX Safety Critical Specification 1.3 is published with-in the Feature Set document (<a
            href="specs/1.3/vx_khr_feature_sets/1.1/html/vx_khr_feature_sets_1_1.html#_safety_critical_deployment_feature_set">HTML</a>,
        <a href="specs/1.3/vx_khr_feature_sets/1.1/vx_khr_feature_sets_1_1.pdf">PDF</a>)
...
<ul>
    ...
    <ul>
        <li>
            This package contains header files for these officially supported extensions <em>and</em> for the
            provisional extensions listed below.
        </li>
    </ul>
</ul>
...
<ul>
    <li>OpenVX KHR Node Send Command V1.0 (vx_khr_node_send_command)
        (<a href="extensions/vx_khr_node_send_command/vx_khr_node_send_command_1_0.html">HTML</a>,
        <a href="extensions/vx_khr_node_send_command/vx_khr_node_send_command_1_0.pdf">PDF</a>)
        (updated Jan 16, 2026).
    </li>
    ...
    <li>OpenVX KHR Sub Image Arrays (vx_khr_sub_image_arrays)
        (<a
            href="extensions/vx_khr_sub_image_arrays/vx_khr_sub_image_arrays_1_3_1/vx_khr_sub_image_arrays_1_3_1.html">HTML</a>,
    ...
    <li>OpenVX KHR Tensor from images (vx_khr_tensor_from_images)
        (<a
            href="extensions/vx_khr_tensor_from_image/vx_khr_tensor_from_image_1_3_1/vx_khr_tensor_from_image_1_3_1.html">HTML</a>,
    ...
    <li>OpenVX KHR Supplementary Data (vx_khr_supplementary_data) [provisional, OpenVX 1.3.1]
        (<a
            href="extensions/vx_khr_supplementary_data/vx_khr_supplementary_data_1_3_1/vx_khr_supplementary_data_1_3_1.html">HTML</a>,
        <a href="extensions/vx_khr_supplementary_data/vx_khr_supplementary_data_1_3_1.pdf">PDF</a>)
        (updated November 20, 2024).
    </li>
    <li>OpenVX KHR Bidirectional Parameters Extension 1.3.1 (vx_khr_bidirectional_parameters) [provisional, OpenVX
        1.3.1]
...
<ul>
    ...
    <li>OpenVX KHR Pipelining, Streaming, And Batch Processing Extension 1.0.1 (vx_khr_pipelining) [provisional, OpenVX
        1.1 and 1.2]
...
<ul>
    ...
    <li>OpenVX KHR XML Schema Extension 1.1 (vx_khr_xml) (provisional, OpenVX 1.0)
        ...
        <ul>
            <li>
                The 1.0 XML extension incorporates the <a href="schema/openvx-1-0.xsd">OpenVX XML Schema 1.0</a>
                document.
            </li>
        </ul>
    </li>
